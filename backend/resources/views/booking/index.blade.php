        ...
        <table class="text-left w-full border-collapse ">
          <thead>
            <tr class="bg-blue-800 text-white">
              ...
              <th class="py-2 px-6 bg-grey-lightest font-bold text-sm text-grey-dark border-b border-grey-light">Action</th>
            </tr>
          </thead>
          <tbody>
            @can('Booking access')
            ...
            <tr class="hover:bg-grey-lighter">
              ...
              <td class="py-2 px-6 border-b border-grey-light">{{ $booking->user->name }}</td>
              <td class="py-2 px-6 border-b border-grey-light">{{ $booking->total_price }}</td>
