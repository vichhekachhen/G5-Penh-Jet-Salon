                                ...
                                <div class="bg-white rounded-lg">
                                    <div class="" x-data="imageData()">
                                        ...
                                        <div x-data="imageData()" class="w-full text-center relative">
                                            ...
                                            {{-- <div x-show="previewUrl === '' && imgurl === ''" class="mt-4">
                                            <label for="thumbnailprev" class="cursor-pointer">
                                                <input type="file" id="thumbnailprev" name="profile"
                                                    @change="updatePreview" class="hidden">
                                                <div
                                                    class="bg-white rounded-full w-36 h-36 mx-auto border-2 border-gray-300 flex items-center justify-center cursor-pointer hover:border-blue-500 transition-all duration-300">
                                                    <i class="bi bi-camera-fill text-gray-400 text-5xl"></i>
                                                </div>
                                                <p class="text-center text-gray-500 mt-2">Upload a new profile picture
                                                </p>
                                            </label>
                                        </div> --}}
                                        </div>
