<template>
  <div>
    <div
      class="flex items-center justify-center p-3 flex-wrap bg-pink-500 sticky top-0 z-50 md:flex-nowrap"
    >
      <button
        type="button"
        @click="fetchService"
      ...
      <button
        v-for="category in useCategory.categories"
        :key="category.id"
        type="button"
            ...
            >
              <div class="flex-1 p-3">
                ...
                <p class="text-pink-500 text-xl font-bold">
                  <span v-if="service.discount" class="line-through text-gray-500"
                    >${{ service.price }}</span
                  >
              ...
              <div class="flex flex-col space-y-4">
                ...
                >
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-red-500 text-base font-bold">${{ item.discount }}</p>
                  </div>
