...
const shops = ref([
  {
    address: 'RUPP-CJCC Russian Federation Blvd (110), Phnom Penh, Cambodia',
    lat: 11.5689714,
    lng: 104.8937056
  },
  { address: 'Prey Veng Province, Cambodia', lat: 11.3802442, lng: 105.5005483 },
  { address: 'Meanchey, Phnom Penh, Cambodia', lat: 11.5344226, lng: 104.8804893 }
])
